      ...
      ? (<div className="flex flex-col h-screen mx-auto items justify-end text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-900 max-w-[630px]">
        ...
        <div className="h-full overflow-auto scrollbar-thin flex justify-center items-center flex-col relative">
          <div className="flex flex-col items-center mb-1 text-center">
            <h1 className="text-6xl font-bold mb-2">Paligemma2 WebGPU</h1>
          ...
          <div className="w-full min-h-[220px] flex flex-col justify-center items-center p-2">
            ...
            <p className="mb-2">
              You are about to download <a href="https://huggingface.co/onnx-community/paligemma2-3b-pt-224" target="_blank" rel="noreferrer" className="font-medium underline">Paligemma-2-3b-pt-224</a>,
